    ...
    <div>
      ...
      <div className="flex space-x-40">
        ...
        <div className="flex px-5">
          ...
          <div>
            <button className="bg-black text-white rounded-full px-3 py-2">Subscribe</button>
          </div>
        </div>

        <div >
            
            <button className="bg-gray-200 rounded-l-full px-5 py-2 border-r-2 border-gray-300">👍</button>
            <button className="bg-gray-200 rounded-r-full px-5 py-2 mr-5">👎</button>
            <button className="bg-gray-200 rounded-full px-5 py-2 mr-5"> ⤴️ Share</button>
            <button className="bg-gray-200 rounded-full px-5 py-2 mr-5"> ⬇️ Download</button>
            <button className="bg-gray-200 rounded-full px-5 py-2 mr-6">...</button>
        </div>
      </div>
      <div className="bg-gray-200 rounded-lg w-95-px h-28 mt-3 flex">
        <p className=" p-2">3000 views</p>
        <p className=" p-2">2 days ago</p>
